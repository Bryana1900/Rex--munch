'use strict';
const perfilDueño = document.querySelector('#perfilDueño');
const perfilAdmin = document.querySelector('#perfilAdmin');
const perfilGerente = document.querySelector('#perfilGerente');
...
if (!usuarioSesion) {
    ...
    switch (usuarioSesion.rol) {
        case 'cliente':
            ...
            perfilGerente.classList.add('ocultar');
            perfilAdmin.classList.add('ocultar');
            perfilDueño.classList.add('ocultar');
